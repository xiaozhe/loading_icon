    ...
    , ui(new Ui::MainWindow)
{
    ...
    m_load02 = new XZ::Wgt::loading_02(this);
    m_load02->setObjectName("loading02");
    m_load02->setGeometry(100, 150, 100, 100);
}
...
void MainWindow::on_pb_merge_png_clicked()
{
    ...
    for(int ifor0 = 1; ifor0 < 41; ifor0 ++){
        QString sLoad = QString("./loading_02_%1.png").arg(ifor0, 3, 10, QChar('0'));
    ...
    p_qp_img->end();
    QString sMerge = QString("./loading_02_merge.png");
...
{
    QString sSrc = QString("./loading_02_merge.png");
    ...
    QString sTar = QString("./loading_02_m_white.png");
